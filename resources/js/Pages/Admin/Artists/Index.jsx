                                    ...
                                    <div className="flex justify-end gap-2 items-center">
                                        ...
                                        {deletingId === artist.id ? (
                                            <>
                                                ...
                                                <button type="button" onClick={() => deleteArtist(artist.id)} className="text-xs text-rose-400 hover:text-rose-300 font-bold">Да</button>
                                                <button type="button" onClick={() => setDeletingId(null)} className="text-xs text-zinc-500 hover:text-zinc-300">Отмена</button>
                                            </>
                                        ) : (
                                            <button type="button" onClick={() => setDeletingId(artist.id)} className="text-xs text-rose-400 hover:text-rose-300 font-bold">Удалить</button>
                                        )}
                                    </div>
                                </td>
                            </tr>
