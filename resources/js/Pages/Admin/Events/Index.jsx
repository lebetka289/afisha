                            ...
                            <tr key={event.id} className="border-t border-white/10 hover:bg-violet-500/[0.03] transition-colors">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <div className="flex justify-end gap-2">
                                        <a href={route('events.show', event.slug || event.id)} className="text-xs text-zinc-500 hover:text-white transition font-bold" target="_blank">Просмотр</a>
                                        <Link href={route('admin.events.edit', event.id)} className="text-xs text-violet-400 hover:text-violet-300 transition font-bold">Изменить</Link>
                                        <button onClick={() => deleteEvent(event.id)} className="text-xs text-rose-400 hover:text-rose-300 transition font-bold">Удалить</button>
                                    </div>
                                </td>
                            </tr>
                        )) : (
