                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    {booking.status !== 'refunded' && (
                        <button 
                            ...
                            className="px-5 py-2.5 bg-rose-500/10 border-2 border-rose-500/30 text-rose-300 hover:bg-rose-500/20 font-black text-xs uppercase tracking-wider transition-colors"
                        >
                            Вернуть билет
                        </button>
                    )}
                ...
                <div className="grid gap-6 lg:grid-cols-[1.4fr,0.8fr]">
                    ...
                    <div className="space-y-6">
                        <div className="border-2 border-violet-500/30 bg-[#0a0a0a] p-6 text-center">
                            ...
                            <p className="text-xs text-zinc-600 mt-4 font-bold">Покажите на входе</p>
                        </div>
