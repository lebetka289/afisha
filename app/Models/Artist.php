...
class Artist extends Model
{
    ...
    {
        return $this->hasMany(ArtistAlbum::class)->orderBy('sort_order')->orderBy('year', 'desc');
    }

    public function favoritedBy(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(User::class, 'artist_favorites', 'artist_id', 'user_id')->withTimestamps();
    }
