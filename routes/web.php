...
Route::middleware('auth')->prefix('notifications')->name('notifications.')->group(function () {
    ...
    Route::post('/read', [\App\Http\Controllers\NotificationController::class, 'markRead'])->name('read');
    Route::post('/{notification}/read', [\App\Http\Controllers\NotificationController::class, 'markOneRead'])->name('read.one');
});
...
Route::middleware('auth')->prefix('cabinet')->name('cabinet.')->group(function () {
    ...
    Route::get('/artist', [CabinetController::class, 'artistProfile'])->name('artist');
    Route::put('/artist', [CabinetController::class, 'updateArtistProfile'])->name('artist.update');
});

Route::middleware(['auth', 'adminOrOrganizer'])->prefix('admin')->name('admin.')->group(function () {
